...
class AuthController {
    async register(req, res) {
        try {
            const { name, email, password, bot_number, notification_number } = req.body;
            const user = await authService.register(name, email, password, bot_number, notification_number);
